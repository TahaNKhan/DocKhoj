...
## p1-T02 — Structured parser (markdown, txt, docx, pdf)
...
## p1-T03 — Tokenizer + sentence splitter
...
## p1-T05 — Semantic-split pass (optional)
...
- **Depends on:** p1-T04, p1-T07 (needs embedText for the test)
- **Estimate:** M
- **Status:** done

## p1-T06 — Public chunk API + legacy shim
...
## p1-T07 — Embed service: parallel + retry + real health check
...
## p1-T08 — Qdrant service: payload indexes + filters + client.query
...
## p1-T09 — Upload routes: dedup + per-file status + parallel embed
...
## p1-T10 — Download route: traversal guard + MIME map
...
## p1-T11 — Chat route: sessionId validation + history cap
...
## p1-T12 — Search route: filter query params + context expansion
...
## p1-T13 — Index: graceful shutdown
...
## p1-T14 — Public UI: DOMPurify + parallel uploads
...
## p1-T15 — Logger: rename + truncate + remove unused
...
## p1-T17 — Route tests via fastify.inject
...
- **Depends on:** p1-T09, p1-T10, p1-T11, p1-T12
- **Estimate:** M
- **Status:** done

## p1-T18 — E2E upload-and-query test
...
- **Depends on:** p1-T02, p1-T04, p1-T06, p1-T07, p1-T08, p1-T09, p1-T12
- **Estimate:** M
- **Status:** done

## p1-T19 — Docker: HEALTHCHECK + Ollama wait + env defaults
...
## p1-T20 — Coverage thresholds + bring coverage up
...
- **Depends on:** p1-T17, p1-T18
- **Estimate:** M
- **Status:** done

## p1-T21 — Final verification + README
